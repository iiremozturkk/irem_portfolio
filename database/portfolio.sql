...
('Industrial Attack Detection System', 'Industrial Attack Detection System', 'Machine-learning based cyber attack detection for industrial systems.', 'Industrial IoT ortamlarında saldırı tespiti yapan makine öğrenmesi tabanlı güvenlik sistemi. 4 farklı AI modeli ile anomali/saldırı tespiti amaçlanır.', 'Python, Machine Learning, Cybersecurity, AI', 'assets/images/project-iiot.svg', 'https://github.com/iiremozturkk/Industrial-Attack-Detection-System', '#', 1, 1),
('Go Product Management', 'Go Product Management', 'RESTful product management system developed with Go.', 'Go backend ve Vue frontend kullanılan ürün yönetim sistemi. Ürün ekleme, listeleme ve yönetme işlemleri için full-stack yapıdadır.', 'Go, REST API, Backend, Database', 'assets/images/project-go.svg', 'https://github.com/iiremozturkk/GoProductManagement', '#', 1, 2),
('Smart Transportation Database', 'Smart Transportation Database', 'Database design for smart transportation systems.', 'Akıllı ulaşım sistemleri için tasarlanmış veritabanı projesi. Araç, rota, durak, yolcu ve ulaşım verilerini yönetmeye odaklanır.', 'SQL, Database Design, Data Management, PHP', 'assets/images/project-transport.svg', 'https://github.com/iiremozturkk/Smart_Transportation_Database', '#', 1, 3),
('Ilanpazar', 'ILANPAZAR', 'Second-hand marketplace platform for listings and product discovery.', 'Kullanıcıların ilan oluşturup görüntüleyebildiği Next.js tabanlı ilan/pazar yeri web uygulaması.', 'PHP, MySQL, JavaScript, CSS', 'assets/images/project-portfolio.svg', 'https://github.com/iiremozturkk/ilanpazar', '#', 1, 4),
('Shopora', 'SHOPORA', 'Full-stack e-commerce marketplace developed with a two-person team.', 'Modern e-ticaret mantığında geliştirilmiş web uygulaması. Ürün arayüzü, kullanıcı işlemleri ve alışveriş deneyimi üzerine kuruludur.', 'Next.js, React, MySQL, JavaScript, Tailwind CSS', 'assets/images/project-shopora.svg', 'https://github.com/iiremozturkk', '#', 1, 5);
